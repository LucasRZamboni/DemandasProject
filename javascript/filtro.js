...
function updateCounters() {
  ...
  function applyStatusFilter() {
    ...
    const filtroVerificando = document.getElementById('filtroVerificando').checked;
  ...
  function handleCheckboxChange() {
    ...
    const checkboxes = document.querySelectorAll('.filtro-control input[type="checkbox"]:not(#filtroTodos)');
  ...
  document.querySelectorAll('.filtro-control input[type="checkbox"]').forEach(checkbox => {
